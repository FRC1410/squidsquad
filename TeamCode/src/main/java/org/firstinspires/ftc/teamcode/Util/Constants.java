...
public final class Constants {
    ...
    public static final double ROTATOR_DOWN_MODIFIER = -1;
    public static final double ROTATOR_UP_MODIFIER = 0.5;
    ...
    //Auto Tuning
    public static final double AUTO_FAST_SPEED_FORWARD = -0.1;
    public static final double AUTO_FAST_SPEED_LEFT = -0.8;
    public static final double AUTO_FAST_SPEED_RIGHT = 0.8;
    public static final double AUTO_SLOW_SPEED_FORWARD = -0.01;
