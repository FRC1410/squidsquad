        ...
        while (!isStopRequested()) {
            ...
            switch (step) {
                ...
                case 0:
                    ...
                    if (Y < SKYSTONE_Y_LOCATION) robot.driveAll(0,-AUTO_SLOW_SPEED_LEFT,0, telemetry);
                    else if (Y > SKYSTONE_Y_LOCATION) robot.driveAll(0,-AUTO_SLOW_SPEED_RIGHT,0, telemetry);
                    else step = 1;
                    telemetry.update();
                    break;
                case 1:
