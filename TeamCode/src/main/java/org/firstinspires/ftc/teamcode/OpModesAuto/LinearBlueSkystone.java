        ...
        while (opModeIsActive()) {
            ...
            switch (step) {
                ...
                case 0:
                    ...
                    if (lifecam.Y < SKYSTONE_Y_LOCATION_LOWER) robot.driveAll(0,-AUTO_SLOW_SPEED_LEFT,0, telemetry);
                    else if (lifecam.Y > SKYSTONE_Y_LOCATION_UPPER) robot.driveAll(0,-AUTO_SLOW_SPEED_RIGHT,0, telemetry);
                    else step = 1;
                    telemetry.update();
                    break;
                case 1:
